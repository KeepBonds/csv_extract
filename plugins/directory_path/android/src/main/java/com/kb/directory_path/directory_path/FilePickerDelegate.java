...
public class FilePickerDelegate implements PluginRegistry.ActivityResultListener, PluginRegistry.RequestPermissionsResultListener {
    ...
    private static final int REQUEST_CODE = (DirectoryPathPlugin.class.hashCode() + 43) & 0x0000ffff;
                ...
                public void run() {
                    if (data != null) {
                        ...
                        if (data.getClipData() != null) {
                            ...
                            Log.d(FilePickerDelegate.TAG, "WESH URI:" + uri.toString());


                            Uri uri2 = data.getData();
                            if (type.equals("dir") && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                Log.d(FilePickerDelegate.TAG, "DOCID:" + DocumentsContract.getTreeDocumentId(uri).toString());
                                ...
                                Log.d(FilePickerDelegate.TAG, " dirPath:" + dirPath.toString());
    ...
    private void finishWithSuccess(Object data) {
        Log.d(FilePickerDelegate.TAG, "FINISH WITH SUCCESS?");
    ...
    private void finishWithError(final String errorCode, final String errorMessage) {
        Log.d(FilePickerDelegate.TAG, "FINISH WITH ERROR?");
