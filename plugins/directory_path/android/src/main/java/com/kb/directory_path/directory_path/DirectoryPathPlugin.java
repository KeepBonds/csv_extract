...
public class DirectoryPathPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {

  private static final String TAG = "FilePicker";
  private static final String CHANNEL = "directory_path";
  private static final String EVENT_CHANNEL = "directory_path.event";
  ...
  public static void registerWith(final io.flutter.plugin.common.PluginRegistry.Registrar registrar) {
    ...
    final DirectoryPathPlugin plugin = new DirectoryPathPlugin();
  ...
  public void onMethodCall(final MethodCall call, final MethodChannel.Result rawResult) {
    ...
    if (call.method != null && call.method.equals("openDir")) {
      String dirPath = "";
    ...
    fileType = DirectoryPathPlugin.resolveType(call.method);
